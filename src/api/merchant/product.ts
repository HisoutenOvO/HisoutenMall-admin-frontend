...
//商家修改商品接口
export const updateMerchantProductApi = (ProductUpdateDTO: MerchantProductUpdateDTO, productId: number) =>
    request.put<Result>(`/merchant/product/${productId}`, ProductUpdateDTO)
